function carregar(){
    ...
    msg.innerHTML = `Agora são ${hora} horas.`
        ...
        if (hora == 1){
            document.getElementsByTagName('h1')[0].innerText = 'Hora da Madrugada'
            ...
            //boa madrugada
            document.getElementsByTagName('h1')[0].innerText = 'Hora da Madrugada'
            msg.innerHTML = `Agora são ${hora}:${min} Horas da madrugadas.`
            img.src = 'imagens/madrugada.png'
            document.body.style.backgroundColor = '#000128'
        } else if (hora >= 6 && hora < 12){
            //bom dia
            document.getElementsByTagName('h1')[0].innerText = 'Hora da Manhã'
            msg.innerHTML = `Agora são ${hora}:${min} Horas da manhã.`
            img.src = 'imagens/manha.png'
            document.body.style.backgroundColor = '#ad8978'
        } else if (hora >= 12 && hora < 18){
            //boa tarde
            document.getElementsByTagName('h1')[0].innerText = 'Hora da Tarde'
